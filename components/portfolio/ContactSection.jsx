...
const EMAILJS_SERVICE_ID = process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || 'service_65jrokc';
const EMAILJS_TEMPLATE_ID = process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || 'template_zi89y67';
const EMAILJS_PUBLIC_KEY = process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || 'eyJMxZaS3Kp_R8qec';
...
export default function ContactSection() {
    ...
    const handleSubmit = (e) => {
        ...
        // EmailJS is configured with default values
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                ...
                                                try {
                                                    ...
                                                    // If mail app doesn't open, copy email to clipboard as fallback
                                                    setTimeout(async () => {
                                                        try {
